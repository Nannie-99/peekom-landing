...
Object.assign(window.PeekomI18nLocales, {
    id: {
        ...
        comparePricing: '<span class="pricing-was">$' + PRICING.list.toFixed(2) + '</span> <span class="pricing-now">$' + PRICING.sale.toFixed(2) + ' USD</span> <span class="pricing-vat">(belum termasuk PPN)</span> · <span class="pricing-launch">Harga peluncuran</span> · sekali bayar · hingga 2 perangkat · pembaruan minor termasuk · refund 7 hari (<a href="mailto:' + CONTACT_EMAIL + '">' + CONTACT_EMAIL + '</a>)',
        guidePlusP: '1) Beli dengan harga peluncuran $9.99 di Lemon Squeezy → 2) Terima kunci lisensi lewat email → 3) Buka Peekom → masukkan kunci di UI kunci atau Pengaturan → 4) Aktivasi Peekom Plus selesai. Refund 7 hari: <a href="mailto:' + CONTACT_EMAIL + '">' + CONTACT_EMAIL + '</a>',
        ...
        contactBody: "Untuk laporan bug, permintaan fitur, atau pertanyaan lisensi, email kami di bawah.",
        ...
        comparePricingExtra: ' · sekali bayar · hingga 2 perangkat · pembaruan minor termasuk · refund 7 hari (<a href="mailto:' + CONTACT_EMAIL + '">' + CONTACT_EMAIL + '</a>)',
    ...
    hi: {
        ...
        comparePricing: '<span class="pricing-was">$' + PRICING.list.toFixed(2) + '</span> <span class="pricing-now">$' + PRICING.sale.toFixed(2) + ' USD</span> <span class="pricing-vat">(VAT अलग)</span> · <span class="pricing-launch">लॉन्च मूल्य</span> · एक बार भुगतान · अधिकतम 2 डिवाइस · माइनर अपडेट शामिल · 7-दिन रिफंड (<a href="mailto:' + CONTACT_EMAIL + '">' + CONTACT_EMAIL + '</a>)',
        guidePlusP: '1) Lemon Squeezy पर लॉन्च मूल्य $9.99 में खरीदें → 2) ईमेल से लाइसेंस कुंजी प्राप्त करें → 3) Peekom खोलें → लॉक UI या सेटिंग्स में कुंजी दर्ज करें → 4) Peekom Plus सक्रियण पूर्ण. 7-दिन रिफंड: <a href="mailto:' + CONTACT_EMAIL + '">' + CONTACT_EMAIL + '</a>',
        ...
        contactBody: "बग रिपोर्ट, फ़ीचर अनुरोध या लाइसेंस पूछताछ के लिए नीचे ईमेल करें।",
        contactEmail: "hello.peekom@gmail.com",
        footerCopy: "© 2026. Peekom All rights reserved.",
        ...
        comparePricingExtra: ' · एक बार भुगतान · अधिकतम 2 डिवाइस · माइनर अपडेट शामिल · 7-दिन रिफंड (<a href="mailto:' + CONTACT_EMAIL + '">' + CONTACT_EMAIL + '</a>)',
    ...
    ar: {
        ...
        comparePricing: '<span class="pricing-was">$' + PRICING.list.toFixed(2) + '</span> <span class="pricing-now">$' + PRICING.sale.toFixed(2) + ' USD</span> <span class="pricing-vat">(باستثناء ضريبة القيمة المضافة)</span> · <span class="pricing-launch">سعر الإطلاق</span> · دفعة واحدة · حتى جهازين · تحديثات فرعية مشمولة · استرداد خلال 7 أيام (<a href="mailto:' + CONTACT_EMAIL + '">' + CONTACT_EMAIL + '</a>)',
        guidePlusP: '1) اشترِ بسعر الإطلاق $9.99 على Lemon Squeezy → 2) استلم مفتاح الترخيص عبر البريد → 3) افتح Peekom → أدخل المفتاح في واجهة القفل أو الإعدادات → 4) اكتمل تفعيل Peekom Plus. استرداد خلال 7 أيام: <a href="mailto:' + CONTACT_EMAIL + '">' + CONTACT_EMAIL + '</a>',
        ...
        contactBody: "لتقارير الأخطاء أو طلبات الميزات أو استفسارات الترخيص، راسلنا عبر البريد أدناه.",
        contactEmail: "hello.peekom@gmail.com",
        footerCopy: "© 2026. Peekom All rights reserved.",
        ...
        comparePricingExtra: ' · دفعة واحدة · حتى جهازين · تحديثات فرعية مشمولة · استرداد خلال 7 أيام (<a href="mailto:' + CONTACT_EMAIL + '">' + CONTACT_EMAIL + '</a>)',
