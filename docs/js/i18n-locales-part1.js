...
window.PeekomI18nLocales.ja = {
    ...
    comparePricing: '<span class="pricing-was">$12.99</span> <span class="pricing-now">$9.99 USD</span> <span class="pricing-vat">(税別)</span> · <span class="pricing-launch">発売記念価格</span> · 買い切り · 最大2台 · マイナーアップデート込み · 7日間返金 (<a href="mailto:hello.peekom@gmail.com">hello.peekom@gmail.com</a>)',
    ...
    versionLatest: "最新", versionWin: "64-bit", versionMac: "Universal",
    changelogTitle: "変更履歴",
    fz1Title: "端から Peek",
    fz1Items: [
...
window.PeekomI18nLocales["zh-CN"] = {
    ...
    comparePricing: '<span class="pricing-was">$12.99</span> <span class="pricing-now">$9.99 USD</span> <span class="pricing-vat">(不含增值税)</span> · <span class="pricing-launch">首发优惠价</span> · 一次性购买 · 最多2台设备 · 含小版本更新 · 7天退款 (<a href="mailto:hello.peekom@gmail.com">hello.peekom@gmail.com</a>)',
    ...
    contactBody: "如有错误报告、功能建议或许可证咨询，请通过下方邮箱联系我们。",
    contactEmail: "hello.peekom@gmail.com",
    footerCopy: "© 2026. Peekom All rights reserved.",
    footerPrivacy: "隐私政策",
...
window.PeekomI18nLocales["zh-TW"] = {
    ...
    comparePricing: '<span class="pricing-was">$12.99</span> <span class="pricing-now">$9.99 USD</span> <span class="pricing-vat">(不含增值稅)</span> · <span class="pricing-launch">首發優惠價</span> · 一次性購買 · 最多2台裝置 · 含小版本更新 · 7天退款 (<a href="mailto:hello.peekom@gmail.com">hello.peekom@gmail.com</a>)',
    ...
    contactBody: "如有錯誤回報、功能建議或授權諮詢，請透過下方電子郵件聯絡我們。",
    contactEmail: "hello.peekom@gmail.com",
    footerCopy: "© 2026. Peekom All rights reserved.",
    footerPrivacy: "隱私權政策",
